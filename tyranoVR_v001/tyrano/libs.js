...
        var path_index =0;
    ...
    */
    ...
    $.cutFloat = function(num,cut_num){
        
        return Math.floor( num * Math.pow( 10, cut_num ) ) / Math.pow( 10, cut_num ); 
    ...
    $.error_message = function(str) {
        ...
        TYRANO.kag.ftag.startTag("vr_message", {"val":str,"color":"0xFF0000","next":false});
        console.log(str);
